...
// Disqus implementation of SiteTuner.
...
// DOM hacking notes:
//
const COMMENT_BLOCK = 'div.post-content';
const COMMENT_TEXT = 'div.post-body div.post-message';


export class DisqusTuner extends SiteTuner {
  siteName = WEBSITE_NAMES.disqus;
